...
search_space = {
    ...
    #"projector_layers": {"_type":"choice", "_value": ["32", "32-32", "64", "64-64", "128", "128-128"]},
}

experiment = Experiment('local')
experiment.config.author_name = 'Jing'
experiment.config.experiment_name = 'nni4nasbench201finetune'
